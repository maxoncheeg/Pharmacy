...
namespace Pharmacy.Forms.Elements
{
	...
	{
		public Label FirstLabel { get; set; }
		public Label SecondLabel { get; set; }
		public Label ThirdLabel { get; set; }
		public PictureBox ActionBox { get; set; }
		public PictureBox DeleteBox { get; set; }
